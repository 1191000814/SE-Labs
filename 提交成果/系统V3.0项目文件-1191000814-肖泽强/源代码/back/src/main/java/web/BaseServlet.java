...
public abstract class BaseServlet extends HttpServlet{
    ...
    {
        System.out.println("-----------启动了类" + this.getClass().getName() + "-----------");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws UnsupportedEncodingException{
        ...
        System.out.println("\n-----执行的action: " + this.getClass().getName() + "------" + action + "---------");
    ...
    protected Object parseData(Class<?> cls, HttpServletRequest req, String message){
        String data = req.getParameter("data");
        System.out.println("\033[34;1m" + "-------> " + message +": " +  data + "\033[0m\n");
